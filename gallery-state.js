  ...
  function normalizeArtworkData(data){
    return arr(clone(data)).map((a,i)=>{
      ...
      return {
        ...
        thumbnail:a.thumbnail||a.thumb||'',
        modelScale:num(a.modelScale,1.8),
        modelAnchor:a.modelAnchor||((a.surface==='partition'||a.wall)?'wall':'floor'),
        modelRotationDeg:num(a.modelRotationDeg??a.modelRotation,0),
        modelHeight:num(a.modelHeight,0),
        modelFallback:a.modelFallback||a.fallbackImage||'',
        modelAttribution:a.modelAttribution||'',
        tags:arr(a.tags),
