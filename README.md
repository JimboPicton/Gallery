...
## Current Version: v9.8.4 – Straight Hallway + Half Wall UX Hotfix

**v9.8.4 — Straight hallway conduit and half-wall creation UX**
...
## v9.8.1 - First-Class Hallway Conduit Refactor
...
## v9.8.1 - Hallway Circulation Network Union
...
## v9.8.4 - Straight Hallway + Half Wall UX Hotfix
...
- Improved Half Wall mode with crosshair cursor, visible start-point marker, clearer status text, Cancel/Escape support, and minimum wall length validation.
- Updated GitHub Pages-facing version information.
